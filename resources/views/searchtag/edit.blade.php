                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        <div>
                            ...
                            <input class="form-control" value="{{$log->title}}" type="text" name="title" id="title" required="">
                        </div>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <div>
                            <label>Title in arabic</label>
                            <input class="form-control" value="{{$log->title_ar}}" type="text" name="title_ar" id="title_ar">
                        </div>
                    </div>
