    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 pt-3">
                ...
                <form  action="{{url('/searchtag/store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar') }}">
