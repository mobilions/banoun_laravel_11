                ...
                <div class="row">
                            ...
                            <select class="form-control @error('variant_id') is-invalid @enderror" name="variant_id" id="variant_id" required onchange="checkcolor()">
                                ...
                                <option value="">Select</option>
                                 ...
                                 @foreach($variants as $list)
                                  ...
                                  <option value="{{$list->id}}" data-variant-name="{{strtolower($list->name)}}" {{ old('variant_id') == $list->id ? 'selected' : '' }}>{{$list->name}} @if($list->name_ar!='')- {{$list->name_ar}}@endif</option>
                    ...
                    <div class="col-lg-4 mb-3" id="color_show" style="display: none;">
                        ...
                        <div>
                           ...
                           <input type="text" name="color_val" class="form-control @error('color_val') is-invalid @enderror" id="colorpicker-default" value="{{ old('color_val', '#50a5f1') }}">
                    ...
                    <div class="col-lg-4 mb-3" id="size_show" style="display: none;">
                        ...
                        <div>
                           ...
                           <input type="text" name="age" class="form-control @error('age') is-invalid @enderror" id="age" value="{{ old('age') }}" placeholder="Enter value">
