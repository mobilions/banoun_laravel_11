...
<div class="col-12">
    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        ...
        <h4 class="mb-sm-0 font-size-16">{{$title}}<a href="{{url('/' . $val . '/create')}}" class="btn btn-primary waves-effect waves-light btn-sm ms-3"><i class="fa fa-plus me-1"></i>Create {{$title}}</a></h4>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($index->title_ar)
                                <br><small class="text-muted">{{$index->title_ar}}</small>
                            @endif
                        </td>

                        <td>
                            <a href="{{url('/' . $index->type . '/' . $index->id . '/edit')}}" class="btn btn-outline-secondary me-2 waves-effect waves-light btn-sm font-size-18" title="Edit">
                                <i class="mdi mdi-pencil"></i>
                            </a>
                            <form action="{{url('/' . $index->type . '/' . $index->id . '/delete')}}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                @csrf
