...
<div class="col-12">
    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        ...
        <h4 class="mb-sm-0 font-size-16">{{$title}}<a href="{{ route('searchtagcreate') }}" class="btn btn-primary waves-effect waves-light btn-sm ms-3"><i class="fa fa-plus me-1"></i>Create {{$title}}</a></h4>
