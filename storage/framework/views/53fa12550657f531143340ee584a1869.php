...
<?php echo $__env->yieldContent('ScriptContent'); ?>
<?php if($errors->any()): ?>
<script>
document.addEventListener('DOMContentLoaded', function () {
    var errorBag = <?php echo json_encode($errors->toArray(), 15, 512) ?>;
...
<?php endif; ?>
<?php if($errors->any() && count(session()->getOldInput() ?? [])): ?>
<script>
document.addEventListener('DOMContentLoaded', function () {
    var oldInput = <?php echo json_encode(session()->getOldInput(), 15, 512) ?>;
    var cssEscape = window.CSS && CSS.escape ? function (value) { return CSS.escape(value); } : function (value) { return value.replace(/([ #;?%&,.+*~:'"!^$[\]()=>|\/@])/g, '\\$1'); };
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\all_project\banoun_laravel_11\resources\views/layouts/scripts.blade.php ENDPATH**/ ?>