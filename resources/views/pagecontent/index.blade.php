            ...
            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$index->id}}</td>
                        <td>{{$index->title}}</td>
                        <td><a href="{{url('/pagecontent')}}/{{$index->id}}/edit" class="btn btn-outline-secondary me-2 waves-effect waves-light btn-sm font-size-18"><i class="mdi mdi-pencil"></i></a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
