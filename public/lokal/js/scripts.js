...
$('#owl-carousel-slider').owlCarousel({
    loop: true,
    navigation: true,
    navText: ["<img src='lokal/images/arrow-left.svg'>", "<img src='lokal/images/arrow-right.svg'>"],
    margin: 10,
    nav: true,
    responsive: {
        0: {
...
$('#browseProductsSection-slider').owlCarousel({
    loop: true,
    navigation: true,
    navText: ["<img src='lokal/images/back.svg'>", "<img src='lokal/images/forward.svg'>"],
    margin: 10,
    nav: true,
    responsive: {
        0: {
