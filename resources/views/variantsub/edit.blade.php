            ...
            <div class="col-sm-12 pt-3">
                ...
                <div class="row">
                            ...
                            <select class="form-control" name="variant_id" id="variant_id" required="">
                                <option value="">Select</option>
                                 @foreach($variants as $list)
                                  <option @if($list->id==$log->variant_id) selected="" @endif value="{{$list->id}}">{{$list->name}}@if($list->name_ar!='')- {{$list->name_ar}}@endif</option>
                                 @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mb-3" id="color_show" style="display: none;">
                        <div>
                            <label>Color</label>
                           <input type="text" value="{{$log->color_val}}" name="color_val" class="form-control" id="colorpicker-default" value="#50a5f1">
                        </div>
                    </div>    
                    ...
                    <div class="col-lg-4 mb-3" id="size_show" style="display: none;">
                        <div>
                           ...
                           <input type="text" value="{{$log->color_val}}" name="age" class="form-control" id="age">
                        </div>
                    </div>              
