    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 pt-3">
                ...
                <form  action="{{url('/usbanner/store')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-lg-4 mb-3">
                    ...
                    <div class="col-lg-6 mb-3" style="display: none;">
                        ...
                        <div>
                            ...
                            <label for="formFileSm" class="form-label">Mobile Image File <small class="text-muted ms-1">(File size should be 1440*400)</small> </label>
