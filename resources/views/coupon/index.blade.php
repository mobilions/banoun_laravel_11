...
<div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0 font-size-16">{{$title}}<a href="{{ route('couponcreate') }}" class="btn btn-primary waves-effect waves-light btn-sm ms-3"><i class="fa fa-plus me-1"></i>Create {{$title}}</a></h4>
        ...
        <div class="card-body">
            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$index->id}}</td>
                        <td>{{$index->coupon_code}}</td>
                        <td>{{$index->price_type}}</td>
                        <td>{{$index->coupon_val}}</td>
                        <td>
                            <!-- <a href="{{url('admin/coupon')}}/{{$index->id}}/edit" class="btn btn-outline-secondary me-2 waves-effect waves-light btn-sm font-size-18"><i class="mdi mdi-pencil"></i></a> -->
                            <form action="{{url('/coupon')}}/{{$index->id}}/delete" method="POST" class="d-inline" onsubmit="return confirm('Delete this coupon?');">
                                @csrf
