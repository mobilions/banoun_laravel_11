                ...
                <div class="row">
                     <div class="col-lg-6 mb-3">
                        <div>
                            ...
                            <input class="form-control" type="text" name="coupon_code" id="coupon_code" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        <div>
                            ...
                            <input class="form-control" type="number" name="coupon_val" id="coupon_val" required="">
                        </div>
                    </div>
